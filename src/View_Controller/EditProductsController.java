...
public class EditProductsController implements Initializable
{
    ...
    @FXML
    private Label modifyProductProductIDLabel;
    @FXML
    private Label modifyProductProductNameLabel;
    @FXML
    private Label modifyProductInvLevelLabel;
    @FXML
    ...
    @FXML
    private Label modifyProductSearchPartLabel;
    @FXML
    private Label modifyProductAssociatedPartsLabel;
    ...
    @FXML
    private TextField modifyProductInvLevelTextField;
    @FXML
    ...
    @FXML
    private TableColumn<Part, Integer> modifyProductCurrentInvLevelCol;
    @FXML
    private TableColumn<Part, Double> modifyProductCurrentPriceCol;
    ...
    public void ModifyProductDeleteButtonPushed(ActionEvent event)
    {
        ...
        alert.setHeaderText("Please Confirm Part Delete");
